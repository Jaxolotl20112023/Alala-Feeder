...
This file contains the main control of each sensor, storing their data, and the overall loop of the whole system. This will eventually be spread out into seperate files, but are stuck into for easier navigation when testing and constantly tweaking the code.  
